...
RED_CAR = scale_image(pygame.image.load("red-car.png"), 0.45)
GREEN_CAR = scale_image(pygame.image.load("green-car.png"), 0.45)

WIDTH, HEIGHT = TRACK.get_width(), TRACK.get_height()
WIN = pygame.display.set_mode((WIDTH, HEIGHT))
pygame.display.set_caption("PYTHON SPRINT RACE EXTRAVAGANZA")
